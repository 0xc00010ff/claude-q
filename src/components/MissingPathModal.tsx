...
export function MissingPathModal({ project, onClose, onRelocate, onRemove }: MissingPathModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-8">
      ...
      <div className="relative w-full max-w-md bg-gunmetal-50 dark:bg-zinc-900 border border-gunmetal-300 dark:border-zinc-800 rounded-lg shadow-2xl animate-in fade-in zoom-in-95 duration-150">
        <button
          onClick={onClose}
        ...
        <div className="p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-xs text-gunmetal-600 dark:text-zinc-400 mt-0.5">
                {project.name}
              </p>
            </div>
          </div>
          ...
          <p className="text-xs text-gunmetal-600 dark:text-zinc-400 mb-5">
